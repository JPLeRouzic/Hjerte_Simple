...
public class Segmentation {
    ...
    public void segmentation(FindBeats norm, int rate) {
        ...
        String Sxname = new String("S3"); // Used for S3 and S4
...
//                    System.out.println("\tS2_" + (countPB - 1) + ", time= " + ((Event) nMB.get(countMB)).timeStampEnd());
                if (eventNbr == 2) {
                    ...
                    Sxname = new String("S2");
                }
                // We must make a special case of S3 and S4
...
//                    System.out.println("This is next S1: " + nxttsPB);
                }

                // Create and add a S2+ event
                eventHMM = recordHMMObs(Sxname,
                        "",
                        curtsMB,
                        bfrPB,
                        nxttsPB,
